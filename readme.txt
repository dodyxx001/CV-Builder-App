...
In this project I learned:
    ...
    - use third party packages- react-to-print and uuid
    - how to create a functional-component based React app

Version 1 took about 10 hours to finish. Implemented in version 1:
- app structure
- basic functionality working
- functional PDF printing
